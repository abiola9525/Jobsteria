function invokeUpdateUser() {
	...
	$.post("UpdateUser.php",{phone : vphone,birth_date : vbirth_date,zipcode : vzipcode,update_ts : vupdate_ts,resume_file_loc : vresume_file_loc,password : vpassword,city : vcity,country : vcountry,avitar : vavitar,state_prov : vstate_prov,username : vusername,aim : vaim,address : vaddress,email : vemail,name : vname,work_phone : vwork_phone,add_ts : vadd_ts,skype : vskype}).done(function(data) {}).fail(function () {});
}
